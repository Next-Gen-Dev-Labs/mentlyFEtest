...
// dashboard svg
export const DashboardIcon: React.FC<IconProps> = ({ isActive, isHovered }) => {
  const strokeColor = isActive || isHovered ? "#1F0954" : "#c2c2c2";
...
// programs svg
export const ProgramsIcon: React.FC<IconProps> = ({ isActive, isHovered }) => {
  const strokeColor = isActive || isHovered ? "#1F0954" : "#c2c2c2";
...
export const ActivitiesIcon: React.FC<IconProps> = ({
  isActive,
  isHovered,
}) => {
  const strokeColor = isActive ? "#1F0954" : "#c2c2c2";
...
export const UsersIcon: React.FC<IconProps> = ({ isActive, isHovered }) => {
  const strokeColor = isActive ? "#1F0954" : "#c2c2c2";
...
export const ForumsIcon: React.FC<IconProps> = ({ isActive, isHovered }) => {
  const strokeColor = isActive ? "#1F0954" : "#c2c2c2";
...
export const FinancesIcon: React.FC<IconProps> = ({ isActive, isHovered }) => {
  const strokeColor = isActive ? "#1F0954" : "#c2c2c2";
...
export const RewardIcon: React.FC<IconProps> = ({ isActive, isHovered }) => {
  const strokeColor = isActive ? "#1F0954" : "#c2c2c2";
...
export const AnaylyticsIcon: React.FC<IconProps> = ({
  isActive,
  isHovered,
}) => {
  const strokeColor = isActive ? "#1F0954" : "#c2c2c2";
...
export const SettingsIcon: React.FC<IconProps> = ({ isActive, isHovered }) => {
  const strokeColor = isActive ? "#1F0954" : "#c2c2c2";
...
export const LogoutIcon: React.FC<IconProps> = ({ isActive, isHovered }) => {
  const strokeColor = isActive ? "#1F0954" : "#c2c2c2";
