...
export default function ManageWidget({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-50">
      <div
        className="absolute inset-0 z-50 backdrop-blur-[2px]"
        onClick={onClose}
      />
      <div className="absolute inset-0 z-50 flex items-center justify-center slide-in">
        <div className="relative z-50 h-full max-w-md min-w-52 md:w-full bg-white ml-auto p-8 md:p-12 space-y-14">
