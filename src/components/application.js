...
export default function Application() {
    return(
        <div className="lg:w-[370px] xl:w-[431px] bg-white py-2 px-4 xl:px-4 space-y-5">
            ...
            <div>
                ...
                <div className=" border-b border-[#DBDBDB] pb-6">
                    ...
                    <span className="border border-[#A5A5A5] w-3.5 h-3.5 mr-2.5 rounded-[2px]"></span>
                    ...
                    <div className="flex gap-2 xl:gap-4 font-medium text-[10px]">
                        <button className="bg-[#FFEDED] border border-[#D09696] py-1.5 xl:py-2.5 px-3 xl:px-6 rounded-md text-[#D83535]">Reject</button>
                        <button className="bg-[#6F01D0] py-1.5 xl:py-2.5 px-3 xl:px-6 text-white rounded-md">Accept</button>
                    </div>
                    </div>
