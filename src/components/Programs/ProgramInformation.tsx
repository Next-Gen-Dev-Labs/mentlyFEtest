...
const ProgramInformation = () => {
  const { expandedId, handleItemClick } = usePrograms();
  ...
  return (
    <div className="p-5 bg-[#FDFDFD] drop-shadow-sm min-h-[calc(100vh-4rem)] flex flex-col gap-5">
      ...
      <div className="flex flex-col gap-1 items-center p-3 border border-mentlyBlue rounded-[0.4rem] justify-center">
      ...
      <div className="flex items-center justify-end gap-[5rem] mt-5">
        ...
        <div className="flex gap-2 items-center bg-mentlyBlue justify-center text-white cursor-pointer py-[1rem] px-4 rounded-[0.5rem]">
