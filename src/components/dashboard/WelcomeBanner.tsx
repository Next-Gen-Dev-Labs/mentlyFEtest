...
const WelcomeBanner: React.FC<WelcomeBannerProps> = ({ username }) => {
  return (
    <div className="bg-gradient-to-r from-techrity-purple to-techrity-purple-light text-white p-4 sm:p-6 rounded-lg flex flex-col md:flex-row justify-between items-center gap-4 md:gap-0 animate-fade-in">
