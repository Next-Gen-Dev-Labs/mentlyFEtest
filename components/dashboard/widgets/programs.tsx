...
export default function Programs({ style }: { style?: CSSProperties }) {
	return (
		...
		>
			<div className="sticky top-0 flex justify-end bg-white pb-2 shadow">
				<label
	...
	({ type, title, bannerImage, description, ...rest }: ProgramType) => (
		<article className="mb-2 rounded-xl bg-white p-3.5 text-xs shadow-md">
			...
			<footer className="flex items-center justify-between">
				...
				<div className="flex items-center gap-1.5 text-[#6f01d0] *:truncate *:rounded-sm *:border *:border-[#6f01d0] *:px-3.5 *:py-1.5 *:transition *:hover:scale-103 *:focus-visible:scale-103 *:active:scale-98">
